...
parser.add_argument('--data_range', type=str, default='2000-2500/300-400',
...
parser.add_argument('--outpath', type=str, default='result',
                    help='set a outputpath for test')

# Model specifications
parser.add_argument('--model', default='metardn',
                    help='model name')

parser.add_argument('--act', type=str, default='relu',
                    help='activation function')
parser.add_argument('--pre_train', type=str, default='/home/gaofei/Meta-SR-Pytorch/experiment/metardn/model/model_200.pt',
